...
void UBlasterAnimInstance::NativeUpdateAnimation(float DeltaTime)
{
	...
	if (BlasterCharacter)
	{
		...
		bUseAimOffsets = BlasterCharacter->GetCombatState() != ECombatState::ECS_Reloading && !BlasterCharacter->GetDisableGamplay();
		bTransformRightHand = BlasterCharacter->GetCombatState() != ECombatState::ECS_Reloading && !BlasterCharacter->GetDisableGamplay();
	}
}
